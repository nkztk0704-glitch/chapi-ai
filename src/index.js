    ...
    try {
      ...
      try {
        ...
        if (saved) {
          ...
          if (Array.isArray(parsed)) {
            memories =
              parsed.map(normalizeLegacyMemory);
          }
        }
      } catch (error) {
        console.error(
